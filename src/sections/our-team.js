...
import amit from 'assets/images/team/amit.jpeg';
...
const data = [
  {
    ...
    socialLinks: [
      {
        name: 'twitter',
        link: 'https://twitter.com/cloudyamit',
      },
      {
        name: 'linkedin',
        link: 'https://www.linkedin.com/in/simplyamit/',
      },
    ],
  },

  {
    ...
    socialLinks: [
      {
        name: 'twitter',
        link: 'https://twitter.com/digitalbhardwaj',
      },
      {
        name: 'linkedin',
        link: 'https://www.linkedin.com/in/digitalbhardwaj/',
      },
    ],
  },
  {
  ...
  //   avatar: avatar3,
  //   name: 'Naresh Oswal',
  //   designation: 'Experience Cloud Architect',
  //   socialLinks: [
  //     {
  //       name: 'twitter',
  //       link: 'http://twitter.com',
    ...
    <Box as="section" id="team" sx={styles.section}>
      <Container ref={containerRef}>
        <SectionHeading
          ...
          description="Our trainers have real-time experience and expertise in teaching Salesforce, they always put great efforts to convert complex topics into easily understandable modules. "
        />
      </Container>
      <Box
        sx={{
