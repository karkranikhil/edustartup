    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Expert Salesforce training  when and where you need it."
            description="In the Salesforce ecosystem, there are over a million job openings. There is a road for you, regardless of your history or interests."
          />
          <Box as="figure" sx={styles.illustration}>
            <Box sx={styles.buttonWrapper}>
             <Button><NavLink path="services" label="Get Started"></NavLink></Button>
            </Box>
